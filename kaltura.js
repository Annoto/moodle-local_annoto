(function () {
    ...
    if (!jsparams) {
        console.warn('Empty params. Annoto will not start.');
        return;
    }
    /*
     *
    ...
    KApps.annotoApp = {
        ...
        annotoSetup: function(params) {
            ...
            */
            ...
            params.config.align.vertical = jsparams.alignVertical;
            params.config.clientId = jsparams.clientId;
            params.config.demoMode = jsparams.demoMode;
            params.config.locale = jsparams.locale;
            params.config.position = jsparams.position;
            params.config.rtl = jsparams.rtl;
