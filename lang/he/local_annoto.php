...
$string['moodlejsurl'] = 'כתובת חבילת ה-JS של Moodle (עקיפה)';
$string['moodlejsurldesc'] = 'השאר ריק כדי לטעון את חבילת moodle-local-js המצורפת לתוסף זה (local/annoto/js/annoto.js). הזן כתובת כדי לטעון אותה ממקום אחר (למשל https://cdn.annoto.net/moodle-local-js/latest/annoto.js).';
