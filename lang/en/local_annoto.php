...
$string['moodlejsurl'] = 'Moodle JS bundle URL (override)';
$string['moodlejsurldesc'] = 'Leave empty to serve the moodle-local-js bundle shipped inside this plugin (local/annoto/js/annoto.js). Provide a URL to load it from elsewhere instead (e.g. https://cdn.annoto.net/moodle-local-js/latest/annoto.js).';
...
$string['privacy:metadata:local_annoto_completiondata'] = 'Per-user Annoto activity used to calculate automatic activity completion.';
$string['privacy:metadata:local_annoto_completiondata:userid'] = 'The ID of the user the completion activity data belongs to.';
$string['privacy:metadata:local_annoto_completiondata:completionid'] = 'The Annoto completion configuration the activity data relates to.';
$string['privacy:metadata:local_annoto_completiondata:data'] = 'The recorded Annoto activity (views, comments and replies) for the user.';
$string['privacy:metadata:local_annoto_completiondata:timecreated'] = 'The time the activity data was first recorded.';
$string['privacy:metadata:local_annoto_completiondata:timemodified'] = 'The time the activity data was last updated.';
